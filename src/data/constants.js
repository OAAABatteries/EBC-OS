...
export const THEMES = {
  ...
  midnight: {
    ...
    vars: {
      ...
      "--yellow":"#ffd60a","--orange":"var(--amber)",
      "--purple":"#a78bfa","--purple-dim":"rgba(167,139,250,0.10)","--cyan":"#22d3ee","--cyan-dim":"rgba(34,211,238,0.10)",
      "--text":"#f5f5f7","--text2":"#98989d","--text3":"#8e8e93","--text-muted":"var(--text3)",
      "--text-on-light":"#0a0e1a","--text-on-dark":"#ffffff",
      "--card":"var(--bg2)","--border-subtle":"var(--border)",
      "--logo-tint":"#f5f5f7",
      "--bg2-rgb":"28,28,30",
  ...
  daylight: {
    ...
    vars: {
      ...
      "--yellow":"#b45309","--orange":"var(--amber)","--purple":"#7c3aed","--purple-dim":"rgba(124,58,237,0.10)","--cyan":"#0891b2","--cyan-dim":"rgba(8,145,178,0.10)",
      "--text":"#1a1d28","--text2":"#555d6e","--text3":"#6b7280","--text-muted":"var(--text3)",
      "--text-on-light":"#0a0e1a","--text-on-dark":"#ffffff",
      "--card":"var(--bg2)","--border-subtle":"var(--border)",
      "--logo-tint":"#0f1a24",
      "--bg2-rgb":"255,255,255",
